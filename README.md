...
De¹ is a leading academic and research-driven financial infrastructure initiative dedicated to building fair, efficient, and native global financial systems for the emerging era where humans and autonomous agents coexist at scale.

It focuses on developing the Financial World Model — a high-fidelity training environment powered by real on-chain execution data. De¹ captures authentic market interactions (MEV, slippage, liquidity fragmentation, and adversarial behavior) that traditional public APIs cannot observe. This enables AI trading agents to continuously learn, adapt, and evolve in a highly realistic environment before deploying capital in live markets.


## Features
### Gasless swapping:
De¹'s gasless swaps simplify DeFi trading by making it faster, more accessible, especially for those trading across multiple chains or new to the space. With gasless swaps, users benefit from fast settlement, secured by Permit2, and built-in MEV protection. Based on Uniswap's Permit2 standards, gasless swaps allow secure token approvals without extra on-chain transactions - users only need to sign and swap. Additionally, users don’t need native tokens like ETH or BNB for gas fees; the gas cost is abstracted and covered as part of the transaction.

### Referrals & Monetization
If you are building DeFi products, trading bots, or arbitrage strategies on top of De¹ Exchange V2, you can easily monetize your flow using our built-in referral system. The router supports referral parameters /referrer and /referrerFee, which can be added directly to the request URL to apply an additional fee.

The referrer parameter is simply an EOA address that you control, making it straightforward to manage. With this setup, you can track your swap activity via De¹ analytics dashboard. This allows developers and integrators to generate passive income from DeFi trades while leveraging De¹’s next-generation DEX aggregation infrastructure.



## Contracts of Chains(EVM Chains)

### **De¹’s current contract addresses:**
...
**Plasma:** [**0x6352a56caadC4F1E25CD6c75970Fa768A3304e64**](https://plasmascan.to/address/0x6352a56caadC4F1E25CD6c75970Fa768A3304e64)
...
**Injective:** [**0x6352a56caadC4F1E25CD6c75970Fa768A3304e64**](https://blockscout.injective.network/address/0x6352a56caadC4F1E25CD6c75970Fa768A3304e64)
...
**TAC Chain:** [**0x6352a56caadC4F1E25CD6c75970Fa768A3304e64**](https://explorer.tac.build/address/0x6352a56caadC4F1E25CD6c75970Fa768A3304e64)
...
**Robinhood:** [**0x6352a56caadC4F1E25CD6c75970Fa768A3304e64**](https://robinhoodchain.blockscout.com/address/0x6352a56caadC4F1E25CD6c75970Fa768A3304e64)
